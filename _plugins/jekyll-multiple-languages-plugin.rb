...
module Jekyll
  ...
  Jekyll::Hooks.register :site, :post_write do |site|
    ...
    if (default_lang == current_lang)
      ...
      files.each do |file_path|
        ...
        # Sets base.php as root index.php
        if (f_path == 'base.php')
          new_path = parts[0] + "/index.php"
          puts "Moving '" + file_path + "' to '" + new_path + "'"
          FileUtils.move(file_path, new_path, :force => true)
        else
  ...
  #   files.each do |file_path|
  #     puts(file_path + "\n\n")
  #     dest_path = "_i18n/" + current_lang + "/_posts/"
  #     FileUtils.mkdir_p(dest_path)
  #     FileUtils.copy(file_path, dest_path + file_path.split('/')[-1])
  #   end
  # end
